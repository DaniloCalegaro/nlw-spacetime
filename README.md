...
<div align="center">
  ...
  <img alt="GitHub Repo Size" src="https://img.shields.io/github/repo-size/DaniloCalegaro/nlw-spacetime">
  <img alt="GitHub Language Count" src="https://img.shields.io/github/languages/count/DaniloCalegaro/nlw-spacetime">
  <img alt="license" src="https://img.shields.io/github/license/DaniloCalegaro/nlw-spacetime">
</div>
<br>
<div align="center">
  <a>
...
$ git clone https://github.com/DaniloCalegaro/nlw-spacetime.git
# ou execute (necessário instalar Github CLI - https://cli.github.com/)
$ gh repo clone DaniloCalegaro/nlw-spacetime
...
Já no Server criaremos um arquivo *.env.local* com os seguintes dados:
````
# Database 
